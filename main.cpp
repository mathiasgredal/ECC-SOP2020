...
int main()
{
    ...
    Point b = Point("89565891926547004231252920425935692360644145829622209833684329913297188986597", "12158399299693830322967808612713398636155367887041628176798871954788371653930");

    Point d = c.DoubleAndAdd(1, a);

    std::cout << "X: " << d.x << std::endl; // 112711660439710606056748659173929673102114977341539408544630613555209775888121
    std::cout << "Y: " << d.y << std::endl; // 25583027980570883691656905877401976406448868254816295069919888960541586679410
